...
export function ProjectionInput({
  ...
  const [method, setMethod] = React.useState<ProjectionInputMethod>(defaultMethod)
  ...
  return (
    <div className="space-y-2">
      ...
      <Tabs value={method} onValueChange={(v) => setMethod(v as ProjectionInputMethod)}>
            ...
            {open && (
              <div className="relative mt-2">
                <div className="absolute top-0 z-50 w-full rounded-md border border-slate-200 bg-white shadow-md dark:border-slate-700 dark:bg-slate-800">
                  ...
                  />
                  <CommandList>
                    {loading && <CommandLoading>Loading projections...</CommandLoading>}
            ...
            >
              {!prjFile ? (
                <div className="flex flex-col items-center justify-center space-y-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-700 dark:text-slate-300">Drop your PRJ file here</p>
                  ...
                  <input
                    ...
                    className="hidden"
                    id="prj-upload"
                    onChange={(e) => e.target.files?.[0] && handlePRJUpload(e.target.files[0])}
                  />
                  <label
                    htmlFor="prj-upload"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="text-left">
                      <p className="text-sm font-medium text-slate-900 dark:text-white">{prjFile.name}</p>
