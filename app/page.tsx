...
import type { Coordinate, NetworkData, GeoJSONFeatureCollection } from "@/lib/types"
import { parseINPFile, convertCoordinates, convertToWGS84, createGeoJSON, generateNewINP } from "@/lib/network-utils"
...
export default function Home() {
  ...
  const [convertedCoordinates, setConvertedCoordinates] = useState<Coordinate[] | null>(null)
  ...
  const handleConvert = () => {
    ...
    const converted = convertCoordinates(networkData.coordinates, sourceProjection, targetProjection)
  ...
  const handleDownload = () => {
    ...
    const newContent = generateNewINP(networkData.originalContent, convertedCoordinates)
